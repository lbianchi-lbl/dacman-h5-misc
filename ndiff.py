...
# From https://github.com/NeurodataWithoutBorders/diff/blob/master/ndiff.py
...
def compare(file1, file2, path_file1='/', path_file2='/'):
...
def main():
    ...
    if len(args) == 2:
        ...
        compare(file1, file2)
    if len(args) == 3:
        file1, file2, path_both = args
        compare(file1, file2, path_file1=path_both, path_file2=path_both)
    if len(args) == 4:
        file1, file2, path_file1, path_file2 = args
